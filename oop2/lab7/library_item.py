...
class LibraryItem(ABC):
    ...
    Subclasses must define ITEM_TYPE and EXTRA_FIELDS for the factory to
    automatically prompt the user for the correct fields.
    """
    ...
    def __init__(self, call_num, title, num_copies, **kwargs):
        ...
        :param kwargs: additional fields specific to the subclass
        """
