...
Then open the whole file in binary to skip any automatic python text parsing. Then do said translate() to process the whole file in a single call.
...
Total function call count from cProfiles: 16.
"""
