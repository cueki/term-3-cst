...
def generate_test_items():
    ...
    item_list = [
        ...
        Book("631.495.302", "Harry Potter 3", 4, author="J K Rowling"),
        Book("123.02.204", "The Cat in the Hat", 1, author="Dr. Seuss"),
        DVD("200.100.500", "The Matrix", 3, release_date="1999-03-31", region_code=1),
        DVD("200.100.501", "Inception", 2, release_date="2010-07-16", region_code=1),
        Journal(
            "300.400.100",
            "Nature Vol. 123",
            1,
